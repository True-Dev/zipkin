 ...
 *
 * <p>Note: While queries here use {@link Select#allowFiltering()}, they do so within a partition
 * key, and only return (traceId, timestamp) tuples. This means the entire spans table is not
